                            ...
                            <ul class="navbar-nav nav-pills" id="menu">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="collapse  nav flex-column" id="submenu1" data-bs-parent="#menu">
                                        <li class="w-100">
                                            <a href="../QuanlyKhoaHoc/Khoahoc/index.php" class="nav-link px-2" data-bs-toggle="tooltip" data-bs-placement="right" title="Khoá học"><i class="bi bi-card-checklist icon-nav" style="padding-right:10px"></i><span class="ms-1">Khoá học</span></a>
                                        </li>
                                        <li>
                                ...
                                <li class="nav-item">
                                    <a href="../QuanlySinhVien/index.php" class="nav-link px-0 align-middle" data-bs-toggle="tooltip" data-bs-placement="right" title="Quản Lý Giảng Viên">
                                ...
                                <table class="table table-bordered table-hover table-responsive" >
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            // $lopList = executeResult($sql2);
                                            $index=1;
                                            foreach($MonhocList as $item){
                                                $query='select * from Khoa where id='.$item['id_khoa'];
                                                $chitiet = executeSingleResult($query);
                                                if ($chitiet != null) {
                                                    $tenkhoa         = $chitiet['tenkhoa'];
                                                }
                                                echo'<tr>
                                                        <td >'.($index++).'</td>
