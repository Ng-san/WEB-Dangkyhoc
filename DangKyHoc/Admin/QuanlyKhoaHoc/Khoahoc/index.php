                    ...
                    <div class="container">
                        <div class="panel panel-primary" style="overflow-x:auto;">
                            ...
                            <div class="panel-body">
                                <a href="add.php">
                                    <button class="btn btn-success" style="margin-bottom: 15px;">Thêm Khoá Học</button>
                                </a>
                                <table class="table table-bordered table-hover table-responsive" >
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $khoahocList = executeResult($sql1);
                                            $index=1;
                                            foreach($khoahocList as $item){
                                                echo'<tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-danger" onclick="deletekhoahoc('.$item['MKH'].')">Xoá</button>
                                                        </td>
                                                    </tr>';
                                            }
                                        ?>
